...
const SYSTEM_PROMPT = [
  ...
  'Map OpenAI model aliases to canonical IDs: astra -> gpt-6-astra, gpt-6 -> gpt-6-astra, sol -> gpt-5.6-sol, terra -> gpt-5.6-terra, luna -> gpt-5.6-luna, 5.5 -> gpt-5.5, 5.5 pro -> gpt-5.5-pro, 5.4 -> gpt-5.4, 5.4 pro -> gpt-5.4-pro, 5.4 mini -> gpt-5.4-mini, 5.4 nano -> gpt-5.4-nano.',
